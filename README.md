...
* 📥 **[Download the Interactive Excel Dashboard](3_Excel_Dashboard/Executive_Dashboard.xlsx)**
* 📂 **[View the Source Code](1_Python_SQL_reserving/)**
...
* **1_Python_SQL_reserving/**: Python scripts for Chain-Ladder Reserving and SQL queries for data aggregation.
